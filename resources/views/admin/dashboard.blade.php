                ...
                <div class="text-box">
                    ...
                    <p class="text-muted">
                        <span class="text-muted color-bottom-txt"><i class="fa fa-edit"></i>
                            ...
                            consectetur adipiscing elit gthn.
                            Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit gthn.
                        </span>
                    </p>
        ...
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel back-dash">
                ...
                <p class="text-muted">
                    ...
                    adipiscing sit ametsit amet elit ftr. Lorem
        ...
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel panel-primary text-center no-boder bg-color-green">
                ...
                <div class="panel-footer back-footer-green">
                    ...
                    Lorem ipsum dolor sit amet sit sit,
                    consectetur adipiscing elitsit sit gthn
                    ...
                    <ul class="chat-box">
                        <li class="left clearfix">
                            <span class="chat-img pull-left">
                                <img src="{{ asset('admin/assets/img/1.png') }}" alt="User" class="img-circle" />
                            </span>
                            <div class="chat-body">
                        ...
                        <li class="right clearfix">
                            <span class="chat-img pull-right">
                                <img src="{{ asset('admin/assets/img/2.png') }}" alt="User" class="img-circle" />
                            </span>
                        ...
                        <li class="left clearfix">
                            <span class="chat-img pull-left">
                                <img src="{{ asset('admin/assets/img/3.png') }}" alt="User" class="img-circle" />
                            </span>
                            <div class="chat-body clearfix">
                                <strong>Jack Sparrow</strong>
                                <small class="pull-right text-muted">
                        ...
                        <li class="right clearfix">
                            <span class="chat-img pull-right">
                                <img src="{{ asset('admin/assets/img/4.png') }}" alt="User" class="img-circle" />
                            </span>
                            <div class="chat-body clearfix">
                                <small class="text-muted">
