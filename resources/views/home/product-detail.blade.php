                ...
                <div class="col-lg-6 col-12 learts-mb-40">
                    <div class="product-images">
                        <button class="product-gallery-popup hintT-left" data-hint="Click to enlarge"
                            data-images='[
                            {"src": "{{ asset('assets/images/product/single/1/product-zoom-1.webp') }}", "w": 700, "h": 1100},
                            {"src": "{{ asset('assets/images/product/single/1/product-zoom-2.webp') }}", "w": 700, "h": 1100},
                            {"src": "{{ asset('assets/images/product/single/1/product-zoom-3.webp') }}", "w": 700, "h": 1100},
                            {"src": "{{ asset('assets/images/product/single/1/product-zoom-4.webp') }}", "w": 700, "h": 1100}
                        ]'><i
                                class="far fa-expand"></i></button>
                        ...
                        <div class="product-thumb-slider">
                            <div class="item">
                                <img src="{{ asset('assets/images/product/single/1/product-thumb-1.webp') }}"
                                    alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('assets/images/product/single/1/product-thumb-2.webp') }}"
                                    alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('assets/images/product/single/1/product-thumb-3.webp') }}"
                                    alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('assets/images/product/single/1/product-thumb-4.webp') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-12 mx-auto">
                            <p>Easy clip-on handle – Hold the brush and dustpan together for storage; the dustpan edge is
                                serrated to allow easy scraping off the hair without entanglement. High-quality bristles –
                                no burr damage, no scratches, thick and durable, comfortable to remove dust and smaller
                                particles. Rubber lip – The rubber lip on the front of the dustpan helps to remove all dust
                                at once.</p>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="tab-pwb_tab">
                    <div class="row learts-mb-n30">
                        <div class="col-12 learts-mb-30">
                            <div class="row learts-mb-n10">
                                <div class="col-lg-2 col-md-3 col-12 learts-mb-10"><img
                                        src="{{ asset('assets/images/brands/brand-3.webp') }}" alt=""></div>
                                <div class="col learts-mb-10">
                                    <p>We’ve worked with numerous industries and famous fashion brands around the world. We
                                        have also created tremendous impacts on fashion manufacturing and online sales. When
                                        we partner with an eCommerce agency, we connect every activity to set the trend and
                                        win customers’ trust. We make sure our customers are always happy with our products.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 learts-mb-30">
                            <div class="row learts-mb-n10">
                                <div class="col-lg-2 col-md-3 col-12 learts-mb-10"><img
                                        src="{{ asset('assets/images/brands/brand-8.webp') }}" alt=""></div>
                                <div class="col learts-mb-10">
                                    <p>Prior to Houdini, there have been many clothing brands that achieved such a roaring
                                        success. However, there’s no other brand that can obtain such a precious position
                                        like us. We have successfully built our site to make more people know about our
                                        products as well as our motto. We’ve been the inspiration for many other small and
                        ...
                        <ul class="product-review-list">
                            <li>
                                <div class="product-review">
                                    <div class="thumb"><img src="{{ asset('assets/images/review/review-1.webp') }}"
                                            alt="">
                                    </div>
                                    <div class="content">
                                        <div class="ratings">
                            ...
                            <li>
                                <div class="product-review">
                                    <div class="thumb"><img src="{{ asset('assets/images/review/review-2.webp') }}"
                                            alt="">
                                    </div>
                                    <div class="content">
                                        <div class="ratings">
                            ...
                            <li>
                                <div class="product-review">
                                    <div class="thumb"><img src="{{ asset('assets/images/review/review-3.webp') }}"
                                            alt="">
                                    </div>
                                    <div class="content">
                                        <div class="ratings">
            ...
            <div class="product-carousel">
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="{{ route('product.detail', ['slug' => 'product-details']) }}" class="image">
                                ...
                                <img src="{{ asset('assets/images/product/s270/product-1.webp') }}" alt="Product Image">
                                <img class="image-hover "
                                    src="{{ asset('assets/images/product/s270/product-1-hover.webp') }}"
                                    alt="Product Image">
                            </a>
                        ...
                        <div class="product-info">
                            <h6 class="title"><a href="{{ route('product.detail', ['slug' => 'product-details']) }}">Boho
                                    Beard Mug</a></h6>
                            <span class="price">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="{{ route('product.detail', ['slug' => 'product-details']) }}" class="image">
                                <img src="{{ asset('assets/images/product/s270/product-2.webp') }}" alt="Product Image">
                                <img class="image-hover "
                                    src="{{ asset('assets/images/product/s270/product-2-hover.webp') }}"
                                    alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i
                                    class="far fa-heart"></i></a>
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            ...
                            <a href="{{ route('product.detail', ['slug' => 'product-details']) }}" class="image">
                                <img src="{{ asset('assets/images/product/s270/product-3.webp') }}" alt="Product Image">
                                <img class="image-hover "
                                    src="{{ asset('assets/images/product/s270/product-3-hover.webp') }}"
                                    alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i
                                    class="far fa-heart"></i></a>
                        ...
                        <div class="product-info">
                            <h6 class="title"><a
                                    href="{{ route('product.detail', ['slug' => 'product-details']) }}">Walnut Cutting
                                    Board</a></h6>
                            <span class="price">
                                $100.00
                            </span>
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="{{ route('product.detail', ['slug' => 'product-details']) }}" class="image">
                                ...
                                <img src="{{ asset('assets/images/product/s270/product-4.webp') }}" alt="Product Image">
                                <img class="image-hover "
                                    src="{{ asset('assets/images/product/s270/product-4-hover.webp') }}"
                                    alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i
                                    class="far fa-heart"></i></a>
                        ...
                        <div class="product-info">
                            <h6 class="title"><a
                                    href="{{ route('product.detail', ['slug' => 'product-details']) }}">Pizza Plate
                                    Tray</a></h6>
                            <span class="price">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="{{ route('product.detail', ['slug' => 'product-details']) }}" class="image">
                                <img src="{{ asset('assets/images/product/s270/product-5.webp') }}" alt="Product Image">
                                <img class="image-hover "
                                    src="{{ asset('assets/images/product/s270/product-5-hover.webp') }}"
                                    alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i
                                    class="far fa-heart"></i></a>
                        ...
                        <div class="product-info">
                            <h6 class="title"><a
                                    href="{{ route('product.detail', ['slug' => 'product-details']) }}">Minimalist Ceramic
                                    Pot</a></h6>
                            <span class="price">
                                $120.00
                            </span>
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="{{ route('product.detail', ['slug' => 'product-details']) }}" class="image">
                                <img src="{{ asset('assets/images/product/s270/product-6.webp') }}" alt="Product Image">
                                <img class="image-hover "
                                    src="{{ asset('assets/images/product/s270/product-6-hover.webp') }}"
                                    alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i
                                    class="far fa-heart"></i></a>
                        ...
                        <div class="product-info">
                            <h6 class="title"><a
                                    href="{{ route('product.detail', ['slug' => 'product-details']) }}">Clear Silicate
                                    Teapot</a></h6>
                            <span class="price">
                                $140.00
                            </span>
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="{{ route('product.detail', ['slug' => 'product-details']) }}" class="image">
                                ...
                                <img src="{{ asset('assets/images/product/s270/product-7.webp') }}" alt="Product Image">
                                <img class="image-hover "
                                    src="{{ asset('assets/images/product/s270/product-7-hover.webp') }}"
                                    alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i
                                    class="far fa-heart"></i></a>
                        ...
                        <div class="product-info">
                            <h6 class="title"><a
                                    href="{{ route('product.detail', ['slug' => 'product-details']) }}">Lucky Wooden
                                    Elephant</a></h6>
                            <span class="price">
                                $35.00
                            </span>
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="{{ route('product.detail', ['slug' => 'product-details']) }}" class="image">
                                ...
                                <img src="{{ asset('assets/images/product/s270/product-8.webp') }}" alt="Product Image">
                                <img class="image-hover "
                                    src="{{ asset('assets/images/product/s270/product-8-hover.webp') }}"
                                    alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i
                                    class="far fa-heart"></i></a>
